...
while (WebUI.verifyElementVisible(findTestObject('Object Repository/Page-All Languages/Respondents/List/OR-RE-LI-Delete all respondents/div_First row'), 
    ...
    WebUI.click(findTestObject('Page-All Languages/Respondents/List/OR-RE-LI-Delete all respondents/span_Remove selected respondents'))
