...
while (scale<17) {
	WebUI.click(driver.findElement())
	//Randomize Rating
	...
	element = driver.findElements(By.xpath(selectedRating))
	//Modify xpath of Rating
	//newRating = WebUI.modifyObjectProperty(findTestObject('Object Repository/Settings/Ideal Profile/OR-Manually configured ideal profile/div_Rating'), 'xpath', '', selectedRating, true)
	//println('Modified Object: ' + selectedRating)
	//Click Rating
	WebUI.click(element)
	scale = scale + 1
}
