...
//    WebUI.click(findTestObject('Object Repository/OR-Complete 15FQ Assessment from Email CN/span_Progress'))
...
if (WebUI.verifyElementVisible(findTestObject('Object Repository/OR-Complete 15FQ Assessment from Email CN/span_Unexpected Problem'), 
    ...
    WebUI.click(findTestObject('Object Repository/OR-Complete 15FQ Assessment from Email CN/input__Accept Checkbox'))

    WebUI.click(findTestObject('Object Repository/OR-Complete 15FQ Assessment from Email CN/button_OK'))
