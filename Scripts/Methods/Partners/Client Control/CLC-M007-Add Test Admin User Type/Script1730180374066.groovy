...
//Step: User Details
WebUI.click(findTestObject('Page-All Languages/Partners/Client Control/OR-CLC-AddNewUser/OR-CLC-AddNewUser-UserDetails/input_User type professional'))
...
GlobalVariable.email = (('jjscabangon+test' + GlobalVariable.timestamp) + '@gmail.com')
...
WebUI.click(findTestObject('Page-All Languages/Partners/Client Control/OR-CLC-AddNewUser/OR-CLC-AddNewUser-UserDetails/input_Receive email yes'))
