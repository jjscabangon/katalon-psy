...
WebUI.click(findTestObject('Page-All Languages/Partners/Client Control/OR-CLC-AddNewUser/div_Email'))

WebUI.click(findTestObject('Page-All Languages/Partners/Client Control/OR-CLC-EditUserDetails/div_Edit user'))
...
try {
    ...
    WebUI.scrollToElement(findTestObject('Page-All Languages/Partners/Client Control/OR-CLC-AddNewUser/OR-CLC-AddNewUser-TrainingSelection/textarea_Training details'), 
        3)
...
'Update User Details'
WebUI.click(findTestObject('Page-All Languages/Partners/Client Control/OR-CLC-EditUserDetails/button_Update'))
