...
WebUI.click(findTestObject('Object Repository/Page-EN/Respondents/List/OR-RE-LI-Add new respondent/div_Male'))

WebUI.setText(findTestObject('Object Repository/Page-EN/Respondents/List/OR-RE-LI-Add new respondent/input_title'), 'Mr.')
...
if (WebUI.verifyElementPresent(findTestObject('Object Repository/Page-EN/Respondents/List/OR-RE-LI-Add new respondent/div_S_DateSelect_Start of Month'), 
    3, FailureHandling.OPTIONAL)) {
    WebUI.click(findTestObject('Object Repository/Page-EN/Respondents/List/OR-RE-LI-Add new respondent/div_S_DateSelect_Start of Month'))
}
...
WebUI.click(findTestObject('Object Repository/Page-EN/Respondents/List/OR-RE-LI-Add new respondent/div_Ethnicity-African American'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Object Repository/Page-EN/Respondents/List/OR-RE-LI-Add new respondent/div_Education'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Object Repository/Page-EN/Respondents/List/OR-RE-LI-Add new respondent/div_Education-Secondary School'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Object Repository/Page-EN/Respondents/List/OR-RE-LI-Add new respondent/div_Job Area'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Object Repository/Page-EN/Respondents/List/OR-RE-LI-Add new respondent/div_Job Area-Chief executive'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Object Repository/Page-EN/Respondents/List/OR-RE-LI-Add new respondent/div_Sector'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Object Repository/Page-EN/Respondents/List/OR-RE-LI-Add new respondent/div_Sector-Other'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Object Repository/Page-EN/Respondents/List/OR-RE-LI-Add new respondent/div_Industry'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Object Repository/Page-EN/Respondents/List/OR-RE-LI-Add new respondent/div_Industry-Agriculture, Forestry and Fishing'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Object Repository/Page-EN/Respondents/List/OR-RE-LI-Add new respondent/div_Language'), FailureHandling.OPTIONAL)
